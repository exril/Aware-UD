...
class PaginationView(discord.ui.View):
    ...
    @discord.ui.button(emoji="<:first:1154735421750788177>", style=discord.ButtonStyle.blurple, disabled=False)
    async def first(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.current = 0
    ...
    @discord.ui.button(emoji="<:back:1154735475437862982>", style=discord.ButtonStyle.green, disabled=False)
    async def previous(
        self, interaction: discord.Interaction, button: discord.ui.Button
    ):
