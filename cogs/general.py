...
class general(commands.Cog):
            ...
            if cog is not None:
                if cog.qualified_name.capitalize() in dr:
                    ...
                    for k in ls1:
                        ...
                        listem.set_footer(text=f"Made by thegeeknova" ,  icon_url=pfp)
    ...
    async def botinfo(self, ctx):
        ...
        embed.set_footer(text=f"Thanks for choosing Aware • Requested By {str(ctx.author)}", icon_url=ctx.author.display_avatar.url)
        page = discord.ui.View()
        page.add_item(discord.ui.Button(label="Get Aware", url=discord.utils.oauth_url(self.bot.user.id)))
    ...
    async def teaminfo(self, ctx: commands.Context):
        ...
        embed.description = (f"**• Head Developer**\n> **[nova](https://discord.com/users/{stars.id})**\n"
    ...
    async def todo(self, ctx: commands.Context):
        ...
        listem = discord.Embed(colour=0xc283fe,
                                     description=f"<...> Duty | [...] Optional\n\n{des}")
        listem.set_author(name=f"{str(ctx.author)}", icon_url=ctx.author.display_avatar.url)
        listem.set_footer(text=f"Made by thegeeknova" ,  icon_url=stars.avatar.url)
